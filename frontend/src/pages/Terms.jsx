...
const SECTIONS = [
  ...
  },
  {
    ...
    body: [
      ...
      "However, a minimum sample quantity of 1 kg applies for sampling requests. Samples are available upon request and are chargeable, with both sample cost and shipping charges payable in advance by the buyer. All necessary certifications, permits, documentation, testing, and other regulatory requirements required for the dispatch or export of samples shall also be prepaid by the buyer.",
    ],
  },
  {
    n: "03",
